   ...
   function navigatetoProductDetails() {
    ...
    return(
        <div className="col-lg-3 col-md-6 populer-product-card-container">
            ...
            <img onClick={navigatetoProductDetails} style={{cursor: "pointer"}} alt="Populer product" className="populer-product-card-image" src={"http://localhost:3001/"+Props.imgurl}/>
